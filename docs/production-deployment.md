...
4. Сохранять непубличные артефакты проверки вне продуктового репозитория, если они содержат локальные абсолютные пути, provider-dashboard screenshots или внутренние операционные детали.
