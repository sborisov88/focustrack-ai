...
- Локальная проверка качества прошла: `lint`, `typecheck`, `test`, `build`, `test:e2e`.
...
- Повторная проверка качества прошла: `lint`, `typecheck`, `test`, `build`, `pnpm audit --audit-level high`, `test:e2e`.
