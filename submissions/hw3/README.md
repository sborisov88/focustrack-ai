# ДЗ 3 — ТЗ, UI-концепции, User Stories

Ссылка Otus: https://otus.ru/learning/493766/#/homework-chat/47735/
...
- описана идея, проблема, целевая аудитория и MVP;
...
```text
Добрый день! Сдаю ДЗ 3 по проекту FocusTrack AI.
