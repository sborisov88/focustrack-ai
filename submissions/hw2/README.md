...
- CoT-цепочка фактически выполнена и зафиксирована по шагам: промпт → сырой ответ агента → результат (`docs/prompts/prompt_methodology.md`);
- показано улучшение на дословных (raw) ответах агента до и после применения правил (`docs/prompts/testing.md`);
