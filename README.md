...
Проект находится на ранней стадии: зафиксирована идея продукта, выбран основной AI coding assistant, подготовлены первые проектные материалы и пример кода для доменной логики прогресса.
